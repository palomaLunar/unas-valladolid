...
<body>
    ...
    <main>
        ...
        <section id="nosotros">
        <div class="equipo">
            <h1>¿Quien esta detras de Luna Nails??</h1>
            <img src="../../unas-valladolid/img-pies/nosotros-empresaria.jfif" alt="valladolid-empresaria">
            <h2>Mi nombre es Patricia Luna </h2>
            <p>manicurista profesional desde haace mas de 10 años, Me especializo en la tecnica esculpida en acrilico de uñas, tambien de una gran experiencia en decoraciones artisicas hechas a mano </p>
            <p>En Luna Nails by Patricia, nos apasiona el cuidado de tus uñas. Somos un equipo de profesionales dedicados a brindarte una experiencia única y personalizada. cuentanos tu idea y nosotros la harenos realidad </p>
            <hr>
